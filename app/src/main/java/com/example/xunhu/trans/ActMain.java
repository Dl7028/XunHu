package com.example.xunhu.trans;
...
import com.example.xunhu.trans.view.fragment.FrHistory;
import com.example.xunhu.trans.view.fragment.FrHome;
import com.example.xunhu.trans.view.fragment.FrPersonal;
import com.example.xunhu.trans.view.fragment.FrTrans;
...
public class ActMain extends FragmentActivity implements RadioGroup.OnCheckedChangeListener {
...
//                hideAll(ft1);
              ...
              if(frHome == null){
                ...
                ft1.replace(R.id.frame_layout,frHome);
                ft1.commit();
                break;
            case R.id.ps_am_button:
...
//                hideAll(ft2);
              /*  if (frHistory !=null){
                ...
                ft2.replace(R.id.frame_layout,frHistory);
                ft2.commit();
                break;
            case R.id.tab_personal:
             ...
             /*   hideAll(ft3);
                ...
                ft3.replace(R.id.frame_layout,frPersonal);
                ft3.commit();
                break;
        }
    }
    ...
    public void onBackPressed() {
        if ((System.currentTimeMillis() - mExitTime) > 2000) {
            Toast.makeText(ActMain.this,"再按一次退出程序",Toast.LENGTH_SHORT).show();
